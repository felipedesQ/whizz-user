 ...
 * @final
 */
class srcWhizz_User_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Whizz\\User\\Controller\\UserController' => 'getUserControllerService.php',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fQjFvjsWPX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/srcWhizz_User_KernelTestDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'srcWhizz_User_KernelTestDebugContainer',
            ...
            'router.cache_class_prefix' => 'srcWhizz_User_KernelTestDebugContainer',
            ...
            'doctrine_migrations.dir_name' => (\dirname(__DIR__, 4).'/src/DoctrineMigrations'),
