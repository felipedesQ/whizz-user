...
class RuntimeException extends \RuntimeException implements ExceptionWithContextInterface
{
    /**
     ...
     */
    public static function create(string $message, $context = null, int $code = 0, \Throwable $previous = null): RuntimeException
    {
